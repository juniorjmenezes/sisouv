...
<html lang="{{str_replace('_', '-', app()->getLocale())}}">
	...
	<head>
		...
		<link href="front/assets/css/gbr.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Global Stylesheets Bundle-->
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="page-loading-enabled page-loading header-tabs-disabled header-menu-enabled bg-body-1">
		...
		<!--layout-partial:layout/header/__top-toolbar.html-->
		@include('front.layout._body-toolbar')
		<!--begin::Main-->
		<!--begin::Root-->
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				<!--begin::Wrapper-->
				<div class="wrapper d-flex flex-column flex-row-fluid px-lg-10" id="kt_wrapper">
